...
export default function StickyHeadTable() {
  ...
  const columns = [
    ...
    { id: 'Description', label: 'Description', minWidth: 70,  align: 'center' },
    {  id: 'ScheduledBy', label: 'Scheduled By',  minWidth: 70,  align: 'center' },
    { id: 'MeetingDate',label: 'Meeting Date',minWidth: 70, align: 'center' },
    { id: 'Duration', label: 'Duration', minWidth: 70 ,  align: 'center'},
    { id: 'Status', label: ' Status', minWidth: 70 ,  align: 'center'},
    { id: 'Action', label: ' Action', minWidth: 100 ,  align: 'center'},
  ];
  
  
  function createData(SN, ProjectTittle, Description, ScheduledBy, MeetingDate, Duration, Status,Action ) {
